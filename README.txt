...
After donwloading the project open it in an IDE such as, IntelliJ, VS Code, Ecliplse, or anything you prefer. After the project is opened follow the instructions below: Create a virtual environment - python -m venv venv
